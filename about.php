                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title line-height-50 text-white">Sastoflights.com is Your Trusted <br> Travel
                                Companion.</h2>
                        </div>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item" data-toggle="tooltip" data-placement="top" title="hello word">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            We are Online Ticketing agency managing tours and travel as service.
                        </p>
                    </div>
                </div><!-- end card-item -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column">
                <div class="card-item ">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            We provide tour packages and ticket booking system online.
                        </p>
                    </div>
                </div><!-- end card-item -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column">
                <div class="card-item ">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Our mission is to provide top notch service for our customer base.
                        </p>
                    </div>
                </div><!-- end card-item -->
            </div><!-- end col-lg-4 -->
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="section-heading margin-bottom-40px">
                    ...
                    <h4 class="title font-size-16 line-height-26 pt-4 pb-2">Sasto Flights was established over a decade ago in the year 2007, and since then, we never looked back. We are a Nepal based Travel ticket providers and We are all about providing better service to our customers.</h4>
                    <p class="sec__desc font-size-16 pb-3">At Sasto Flights, we know what makes your heart flutter when it comes to ticket booking. A deep longing to go abroad for studies, work or for travel purposes, new places and return home with a true sense of what life is all about.</p>
                    <p class="sec__desc font-size-16 pb-3">We seek to provide a insights to people regarding the international taravel and tours and provide a better service to aid the customers in this department.</p>
                    <p class="sec__desc font-size-16">We spend most of our time in flight and ticket booking industry, this is what we do best, and we enjoy our work.</p>
                </div><!-- end section-heading -->
            </div><!-- end col-lg-6 -->
            <div class="col-lg-5 ml-auto">
                <div class="image-box about-img-box">
                    <img src="assets/images/img24.jpg" alt="about-img" class="img__item img__item-1">
                    <img src="assets/images/img25.jpg" alt="about-img" class="img__item img__item-2">
                </div>
            </div><!-- end col-lg-5 -->
        </div><!-- end row -->
    </div><!-- end container -->
                ...
                <div class="col-lg-3 responsive-column">
                    <div class="counter-item counter-item-layout-2 d-flex">
                        ...
                        <div class="counter-content">
                            ...
                            <p class="counter__title">Flight Partners</p>
        ...
        <div class="row padding-top-100px">
            <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="assets/images/team1.jpg" alt="team-img">
                    </div>
                    <div class="card-body">
                        <h3 class="card-title">David Roberts</h3>
                        <p class="card-meta">Founder & Director</p>
                        <p class="card-text font-size-15 pt-2">Ligula vehicula enenatis semper, magna lorem aliquet
                            lacusin ante dapibus dictum fugats vitaes nemo minima.</p>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="assets/images/team2.jpg" alt="team-img">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="assets/images/team3.jpg" alt="team-img">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="assets/images/team4.jpg" alt="team-img">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="assets/images/team5.jpg" alt="team-img">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item team-card">
                    <div class="card-img">
                        <img src="assets/images/team6.jpg" alt="team-img">
                    </div>
                    <div class="card-body">
