                    ...
                    <div class="search-fields-container mt-4">
                        <div class="section-tab section-tab-2 pb-3">
                            <ul class="nav nav-tabs" id="myTab3" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active font-size-20 font-weight-bold" id="one-way-tab"
                                        data-bs-toggle="tab" href="#one-way" role="tab" aria-controls="one-way"
                                        aria-selected="true">
                                        One way
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link font-size-20 font-weight-bold" id="round-trip-tab"
                                        data-bs-toggle="tab" href="#round-trip" role="tab" aria-controls="round-trip"
                                        aria-selected="false">
                                        Round Trip
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link font-size-20 font-weight-bold" id="multi-city-tab"
                                        data-bs-toggle="tab" href="#multi-city" role="tab" aria-controls="multi-city"
                                        aria-selected="false">
                                        Multi City
                                    </a>
                                </li>
                                    ...
                                    <form action="#" class="row align-items-center">
                                                                ...
                                                                <div class="form-group">
                                                                    <div
                                                                        ...
                                                                        <select class="form-select">
                                                                            ...
                                                                            <option value="X4">Air Excursions LLC
                                                                            </option>
                                                                            <option value="AF">Air France</option>
                                                                            <option value="NY">Air Iceland Connect
                                                                            </option>
                                                                            ...
                                                                            <option value="OY">Andes Lineas Aereas
                                                                            </option>
                                                                            ...
                                                                            <option value="J2">Azerbaijan Airlines
                                                                            </option>
                                                                            ...
                                                                            <option value="SN">Brussels Airlines
                                                                            </option>
                                                                            <option value="A7">Calafia Airlines</option>
                                                                            <option value="K6">Cambodia Angkor Air
                                                                            </option>
                                                                            <option value="BW">Caribbean Airlines
                                                                            </option>
                                                                            ...
                                                                            <option value="ET">Ethiopian Airlines
                                                                            </option>
                                                                            ...
                                                                            <option value="HX">Hong Kong Airlines
                                                                            </option>
                                                                            ...
                                                                            <option value="DV">JSC Aircompany SCAT
                                                                            </option>
                                                                            ...
                                                                            <option value="MH">Malaysia Airlines
                                                                            </option>
                                                                            ...
                                                                            <option value="WZ">Red Wings Airlines
                                                                            </option>
                                                                            ...
                                                                            <option value="/Y">Scoot with baggage
                                                                            </option>
                                                                            <option value="BB">Seaborne Airlines
                                                                            </option>
                                                                            <option value="SC">Shandong Airlines
                                                                            </option>
                                                                            ...
                                                                            <option value="TJ">Tradewind Aviation
                                                                            </option>
                                                                            ...
                                                                            <option value="HY">Uzbekistan Airways
                                                                            </option>
                                                                            ...
                                                                            <option value="F1">Viva Air Colombia
                                                                            </option>
                                                                            <option value="VV">Viva Airlines Peru
                                                                            </option>
                                        ...
                                        <div class="col-lg-3 pr-0">
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <!-- select-contain select-contain-shadow w-100 -->
...
<!-- ================================
    Top sticky icon box end
================================= -->

<!-- ================================
    Featured Flight Section Start
================================= -->
<section class="destination-area padding-top-20px padding-bottom-80px">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<section class="info-area padding-bottom-70px">
    <div class="container">
        ...
        <div class="row padding-top-50px position-sticky">
...
<!-- ================================
    START INFO AREA
================================= -->
<!-- destination-area position-relative section-bg padding-top-100px padding-bottom-140px -->
<section class="info-area padding-top-20px padding-bottom-70px position-relative destination-area">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
        ...
        <div class="row padding-top-60px position-sticky">
            <div class="col-lg-3 responsive-column">
                <div class="icon-box icon-layout-2 d-flex">
                    ...
                    <div class="info-content">
                        <h4 class="info__title section-heading">Easy to Book</h4>
                        <p class="info__desc">
