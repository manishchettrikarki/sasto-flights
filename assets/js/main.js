! function (e) {
    ...
    t.on("load", function () {
        ...
        t.on("scroll", function () {
            ...
            }, 600), e(this).addClass("active"), t.preventDefault()
            ...
            dropRadius: 20,
            perturbance: 0
        }), e(k).length && e(k).masonry({}), e(C).length && e(C).slider({
            range: !0,
            min: 0,
            max: 1e3,
            values: [40, 800],
        ...
        }), e(T).val("$" + e(C).slider("values", 0) + " - $" + e(C).slider("values", 1)), e(x).length && e(x).slider({
            range: !0,
            min: 0,
            max: 1e3,
            values: [40, 800],
        ...
        }), e(S).val("$" + e(x).slider("values", 0) + " - $" + e(x).slider("values", 1)), e(D).length && e(D).daterangepicker({
            opens: "right",
            locale: {
                format: "DD/MM/YYYY"
            }
            ...
            speed: 1200
        }), e('[data-toggle="tooltip"]').length && e('[data-toggle="tooltip"]').tooltip(), l.on("click", ".add-flight-btn", function () {
